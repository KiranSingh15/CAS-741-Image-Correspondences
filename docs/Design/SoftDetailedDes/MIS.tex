...
[image\_IDs, num\_images] = config.get\_img\_IDs(head\_dir) \newline \newline
...
\noindent [mthd\_img\_smoothing, mthd\_kp\_detection, 
  mthd\_kp\_description, mthd\_ft\_match] \\ = specParams.get\_assigned\_methods() 
\begin{itemize}
