...
The SRS shall be reviewed by each member of the reviewer team to form consensus 
that \\
\begin{itemize}
...
the use of Github Issues. Specifically, both reviewers will use the \textbf{SRS Checklist}. 
